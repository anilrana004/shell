  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        style={{ color: searchOpen ? "#E8541A" : "#4A5E52" }}
      ...
      <a
        ...
        className="flex items-center gap-1.5 text-xs font-medium transition-colors hover:text-[#1A2A1E] hidden lg:flex"
        style={{ color: "#4A5E52" }}
      >
        <Phone size={13} />
        +91-82798 88470
...
export function Navbar() {
  ...
  useEffect(() => {
    if (activeMega || searchOpen) {
      pin("navbar-overlay");
      return () => unpin("navbar-overlay");
    }
    unpin("navbar-overlay");
  }, [activeMega, searchOpen, pin, unpin]);
  ...
  return (
    <header
      className={`hidden md:block md:fixed md:top-0 md:inset-x-0 md:z-40 transition-transform duration-300 ease-out will-change-transform ${
        headerVisible ? "md:translate-y-0" : "md:-translate-y-full"
      }`}
      data-ocid="navbar"
    >
      {/* Announcement bar */}
      ...
      <nav
        ...
        style={{
          ...
          boxShadow: "0 2px 16px rgba(46,125,79,0.1)",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 w-full flex items-center justify-between">
          ...
          >
            <Logo size={40} showWordmark className="text-lg" />
          </Link>
          ...
          <div className="flex items-center gap-0.5">
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Link
                        to="/treks"
                        style={{ color: "#E8541A" }}
                        className="text-xs hover:text-[#1A2A1E] transition-colors font-medium"
                      >
                        View All 14 →
                      </Link>
                    </div>
                    ...
                    <div
                      ...
                      style={{ borderTop: "1px solid #E8541A1A" }}
                    >
                      <Link
                        to="/trek-finder"
                        onClick={() => setActiveMega(null)}
                        ...
                        style={{
                          background: "#E8541A15",
                          border: "1px dashed #E8541A55",
                        }}
                      >
                        <Sparkles size={16} style={{ color: "#E8541A" }} />
                        <div>
                          <p
                            style={{ color: "#1A2A1E" }}
                      ...
                      >
                        <BarChart2 size={16} style={{ color: "#E8541A" }} />
                        <div>
                          <p
                            style={{ color: "#1A2A1E" }}
                            className="text-xs font-semibold"
            ...
            >
              <button
                ...
                className="flex items-center gap-1 px-3 py-2 text-sm font-medium transition-colors"
                style={{
                  color: pathname.startsWith("/yatras") ? "#E8541A" : "#4A5E52",
                }}
            ...
            <Link
              ...
              style={{
                color: pathname === "/packages" ? "#E8541A" : "#4A5E52",
              }}
            >
              Packages
            </Link>
            ...
            <Link
              ...
              className="px-3 py-2 text-sm font-medium transition-colors"
              style={{
                color: pathname === "/corporate" ? "#E8541A" : "#4A5E52",
              }}
            >
              Corporate
            </Link>
                  ...
                  >
                    {[
                      ...
                      <Link
                        ...
                        style={{
                          color: pathname === to ? "#E8541A" : "#4A5E52",
                        }}
                      >
                        <Icon size={14} />
        ...
        <AnimatePresence>
          {searchOpen && (
            <motion.div
              ...
              style={{
                background: "#EDF7F2",
                borderBottom: "1px solid #E8541A33",
              }}
            >
                ...
                {filteredTreks.length > 0 && (
                  <div className="mt-2 space-y-1">
                    {filteredTreks.slice(0, 5).map((t) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <Mountain size={14} style={{ color: "#E8541A" }} />
                          <span
                            style={{ color: "#1A2A1E" }}
